...
class PagesController extends Controller {
  ...
  {
    Excel::filter('chunk')->load(public_path() . '/uploads/file_less_columns_full.csv')->chunk(1000, function($spreadsheet)
    {
      $report_date = [
      ...
      foreach($spreadsheet as $key => $row)
      {
        // $dataset = [
        //   'dataset'       => $row->dataset,
        //   if($row->dataset=='AXA - Imperial WNS')
        //     {'group' => 2;},
        //   'friendly_name' => if($row->dataset=='AXA - Imperial WNS')
        //     'ICL'
        // ];
